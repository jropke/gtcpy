...
public class ContactDBH
{

    private ContactDBH manager;
    // define constants
    ...
    private static final String DATABASE_NAME = "PhonebookDBH";
    private static final String DATABASE_TABLE = "ContactsH";
    private static final int DATABASE_VERSION = 1;

    private static final String DATABASE_CREATE = "create table ContactsH (ContactID integer primary key, Nombre text not null, Dep text not null, Ciudad text not null, Telefono text not null);";
  ...
  //open db
    public ContactDBH open() throws SQLException
    {
