...
import com.nnit.guiacopaco.ContactListH;

import java.io.ByteArrayOutputStream;
import java.util.ArrayList;

public class ContactDetailsH extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_contact_details_h);
		...
		llamar_bar.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				Dialog dialog = new AlertDialog.Builder(ContactDetailsH.this)
				...
				Dialog dialog = new AlertDialog.Builder(ContactDetailsH.this)
						...
						.setPositiveButton(resources.getString(R.string.lable_okbtn), new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								try {
									result = ContactDetailsH.this.getContentResolver().applyBatch(ContactsContract.AUTHORITY, ops);
							...
							private int queryRawIDByData(String dataColumn, String dataValue) {
								ContentResolver resolver = ContactDetailsH.this.getContentResolver();
	...
	public void deleteContact(View view)
	{
		try
		{
			...
			Intent contactList = new Intent(this,ContactListH.class);
